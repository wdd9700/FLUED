...
```text
<archive-root>\v3_checkpoint_audit_20260703
```

输出文件：

```text
<archive-root>\v3_checkpoint_audit_20260703\runs.csv
<archive-root>\v3_checkpoint_audit_20260703\runs.json
<archive-root>\v3_checkpoint_audit_20260703\checkpoint_evidence_audit.md
<archive-root>\v3_checkpoint_audit_20260703\probe_suite\probe_suite.csv
<archive-root>\v3_checkpoint_audit_20260703\probe_suite\probe_suite.json
<archive-root>\v3_checkpoint_audit_20260703\probe_suite\probe_suite.md
```
