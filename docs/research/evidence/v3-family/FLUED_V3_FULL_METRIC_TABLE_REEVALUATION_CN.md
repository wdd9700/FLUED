...
```text
tools/eval/v3_0/eval_v3_checkpoint_probe_suite.py
```
...
```text
<archive-root>\v3_checkpoint_audit_20260703\full_metric_table_representative
```

全量 latest checkpoint 轻量评估：

```text
<archive-root>\v3_checkpoint_audit_20260703\full_metric_table_latest
```

Backbone strict masked-source paired sweep：

```text
<archive-root>\v3_strict_backbone_full_table_20260703
```
