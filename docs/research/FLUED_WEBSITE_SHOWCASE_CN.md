...
| v3.4 L2 重建准确率 | 0.7041 |
| v3.4 L2 masked completion | 0.1477 |
| v3.4 L2 实际 latent/byte | 0.6804 |
| v3.4 状态 | 37M、5K、单种子结构筛选 |

## 展示结构

1. Research question：为什么 byte-to-latent。
2. Timeline：v1 -> v2 -> v3.1 -> v3.2.1 -> v3.3 -> v3.4。
