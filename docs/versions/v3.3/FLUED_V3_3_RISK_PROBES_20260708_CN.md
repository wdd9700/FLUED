...
python tools/analysis/v3_3/probe_v33_architecture_risks.py `
  --config configs/v3_3/v33_full_300m_100m_corpus_v4.json `
  --trials 32 `
  --out-json <archive-root>\v33_efficiency_bench_20260708\v33_arch_risk_probe_after_user_response.json
```
