...
```text
1. docs/versions/v3.1/docs\versions\v3.1\FLUED_V3_1_ARCHITECTURE_CN.md
2. docs/versions/v3.2/docs\versions\v3.2\FLUED_V3_2_DESIGN_SUPPLEMENT_CN.md
3. 本文
```
...
```text
docs/versions/v3.1/docs\versions\v3.1\FLUED_V3_1_ARCHITECTURE_CN.md
docs/versions/v3.2/docs\versions\v3.2\FLUED_V3_2_DESIGN_SUPPLEMENT_CN.md
docs/versions/v3.2/docs\versions\v3.2\FLUED_V3_2_EXECUTION_GOALS_CN.md
```
...
```text
1. 完成 docs/versions/v3.2/docs\versions\v3.2\FLUED_V3_2_DESIGN_SUPPLEMENT_CN.md。
2. 完成本文。
...
tools/launcher/v3_1/run_v31_language_codec_2m_5080.ps1
...
```text
tools/analysis/v3_2/train_v32_language_codec_2m.py
tools/analysis/v3_2/summarize_v32_language_codec.py
tools/eval/v3_2/eval_v32_language_codec_memory_cases.py
[planned, not implemented] eval_v32_language_codec_decoder.py
tools/eval/v3_2/eval_v32_language_codec_roi.py
tools/launcher/v3_2/run_v32_language_codec_2m_5080.ps1
```
...
python -m py_compile `
  tools\analysis\v3_2\train_v32_language_codec_2m.py `
  tools\analysis\v3_2\summarize_v32_language_codec.py
```
...
```powershell
$env:KMP_DUPLICATE_LIB_OK='TRUE'
python tools\analysis\v3_2\train_v32_language_codec_2m.py `
  --out-dir <archive-root>\v32_language_codec_2m_20260703\smoke_cpu `
  --device cpu `
  --seq-len 64 `
  --stride 32 `
  --batch-size 4 `
...
$env:KMP_DUPLICATE_LIB_OK='TRUE'
python tools\analysis\v3_2\train_v32_language_codec_2m.py `
  --data-path <corpus-path> `
  --out-dir <archive-root>\v32_language_codec_2m_20260703\stage1_seed_1k `
  --device cuda --amp `
...
```powershell
python tools\analysis\v3_2\summarize_v32_language_codec.py `
  <archive-root>\v32_language_codec_2m_20260703 `
  --out-path <archive-root>\v32_language_codec_2m_20260703\sweep_summary.md

# 历史计划中的独立 v3.2 decoder 诊断入口最终未实现；
# 实际 decoder/ROI 证据由现有 v3.2 ROI、memory 和 strict-readout 脚本覆盖。

python tools\eval\v3_2\eval_v32_language_codec_memory_cases.py `
  --checkpoint <archive-root>\v32_language_codec_2m_20260703\stage1_seed_1k `
  --device cpu
```
...
```text
run:
  <archive-root>\v32_language_codec_2m_20260703\stage1_seed_1k
...
```text
run:
  <archive-root>\v32_language_codec_2m_20260703\stage2_causal_memory_1k
...
```text
run:
  <archive-root>\v32_language_codec_2m_20260703\stage2_causal_memory_3k
...
```text
memory-case:
  <archive-root>\v32_language_codec_2m_20260703\stage2_causal_memory_3k\memory_cases.md

ROI heatmap:
  <archive-root>\v32_language_codec_2m_20260703\stage2_causal_memory_3k\roi_heatmap.html
...
```text
run:
  <archive-root>\v32_language_codec_2m_20260703\stage2_causal_memory_10k
...
样本级诊断:
  memory-case:
    <archive-root>\v32_language_codec_2m_20260703\stage2_causal_memory_10k\memory_cases.md
  ROI heatmap:
    <archive-root>\v32_language_codec_2m_20260703\stage2_causal_memory_10k\roi_heatmap.html
...
```text
run:
  <archive-root>\v32_language_codec_2m_20260703\stage2_causal_nomemory_10k
...
v3.1 对照:
  <archive-root>\v31_language_codec_2m_20260702\codec_10k_utf8clean
  <archive-root>\v31_language_codec_2m_20260702\codec_10k_pool_mfl

v3.2 对照:
  <archive-root>\v32_language_codec_2m_20260703\stage2_causal_memory_10k
  <archive-root>\v32_language_codec_2m_20260703\stage2_causal_nomemory_10k
  <archive-root>\v32_language_codec_2m_20260703\stage3_v32_mean_random_10k
  <archive-root>\v32_language_codec_2m_20260703\stage3_v32_mfl_memory_10k
  <archive-root>\v32_language_codec_2m_20260703\stage3_v32_mfl_nomemory_10k
  <archive-root>\v32_language_codec_2m_20260703\stage3_v32_mfl_random_10k
...
Stage 3 诊断:
  ...
  mfl top-k 同 checkpoint ablation:
    <archive-root>\v32_language_codec_2m_20260703\stage3_v32_mfl_memory_10k\memory_ablation_streaming.md
  ...
  mfl memory-case / ROI:
    <archive-root>\v32_language_codec_2m_20260703\stage3_v32_mfl_memory_10k\memory_cases.md
    <archive-root>\v32_language_codec_2m_20260703\stage3_v32_mfl_memory_10k\roi_heatmap.html
...
```text
归档:
  <archive-root>\v32_backbone_20260703
...
```text
归档:
  <archive-root>\v32_strict_backbone_20260703

严格脚本:
  tools/analysis/v3_2/train_v32_strict_masked_backbone.py
...
```text
脚本:
  tools/eval/v3_2/eval_v32_strict_readout_diagnostics.py

输出:
  <archive-root>\v32_strict_backbone_20260703\readout_diag_nomemory.json
  <archive-root>\v32_strict_backbone_20260703\readout_diag_memory.json
...
```text
2026-07-03 落地入口:
  tools/analysis/v3_2/train_v32_masked_codec_2m.py
  tools/launcher/v3_2/run_v32_masked_codec_2m_5080.ps1
...
masked-source codec 归档:
  <archive-root>\v32_masked_codec_2m_20260703
...
strict backbone 回测归档:
  <archive-root>\v32_strict_backbone_20260703_masked_codec
...
strict backbone 回测归档:
  <archive-root>\v32_strict_backbone_20260703_masked_codec_15k
...
复现入口:
  tools/launcher/v3_2/run_v32_masked_codec_2m_5080.ps1
  tools/launcher/v3_2/run_v32_strict_masked_backbone_v321_5080.ps1
```
...
```text
诊断入口:
  tools/eval/v3_2/eval_v32_masked_memory_stress.py
  tools/launcher/v3_2/run_v32_masked_memory_stress_5080.ps1

归档:
  <archive-root>\v32_masked_codec_2m_20260703\memory_stress_15k
