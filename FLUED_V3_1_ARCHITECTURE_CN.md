...
```text
命令：
  python tools/analysis/train_v31_language_codec_2m.py
    --out-dir K:\FLUED_archive\smoke_v31_language_codec
...
```text
run:
  K:\FLUED_archive\v31_language_codec_2m_20260702\codec_40k_utf8clean
