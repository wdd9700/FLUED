...
```text
Read `FLUED_V3_1_ARCHITECTURE_CN.md` for the current Chinese explanation of
...
The older `tools/analysis/train_v3_segmental_diffusion_2m.py` remains useful as
...
tools/analysis/summarize_v31_min_backbone.py
