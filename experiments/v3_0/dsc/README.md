...
| 文件 | 说明 | 行数 |
|------|------|------|
| [`flued_dsc_model.py`](flued_dsc_model.py) | 核心模型实现 | ~350 |
| [`train_flued_dsc.py`](train_flued_dsc.py) | 训练脚本（两阶段） | ~280 |
| [`benchmark_flued_dsc.py`](benchmark_flued_dsc.py) | 对照实验框架 | ~250 |
| [`MATH_DERIVATION.md`](MATH_DERIVATION.md) | 数学推导 | ~200 |
...
import torch
from flued_dsc_model import DSCAttention
