...
DEFAULT_RAW_CKPT = Path(r"K:\FLUED_archive\v3_commit_controller_20260629\scale6m_seq128_raw_active_memory_15k\latest.pt")
DEFAULT_GATED_CKPT = Path(r"K:\FLUED_archive\v3_commit_controller_20260629\scale6m_seq128_gated_active_memory_15k\latest.pt")
DEFAULT_OUT_DIR = Path(r"K:\FLUED_archive\v3_diagnostics_20260629\stability")
