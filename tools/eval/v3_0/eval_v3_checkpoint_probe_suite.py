...
from tools.analysis.v3_2.train_v32_language_codec_2m import V32LanguageCodec2M, build_segments  # noqa: E402
from tools.analysis.v3_2.train_v32_strict_masked_backbone import StrictMaskedCollator, targets_from_masked_segments  # noqa: E402
from tools.eval.v3_2.eval_v32_language_codec_memory_ablation import forward_with_mode as v32_forward_with_memory_mode  # noqa: E402


DEFAULT_CHECKPOINTS = [
    r"archive\v31_language_codec_2m_20260702\codec_40k_utf8clean\latest.pt",
    r"archive\v31_language_codec_2m_20260702\codec_10k_pool_mfl\latest.pt",
    r"archive\v32_language_codec_2m_20260703\stage3_v32_mfl_nomemory_10k\latest.pt",
    r"archive\v32_language_codec_2m_20260703\stage3_v32_mfl_memory_10k\latest.pt",
    r"archive\v32_language_codec_2m_20260703\stage3_v32_mfl_random_10k\latest.pt",
    r"archive\v32_masked_codec_2m_20260703\v321_mfl_nomemory_masked_15k\latest.pt",
    r"archive\v32_masked_codec_2m_20260703\v321_mfl_memory_masked_15k\latest.pt",
]
...
def batch_to_device_starts(masked_src: torch.Tensor, valid: torch.Tensor, args: argparse.Namespace) -> torch.Tensor:
    ...
    from tools.analysis.v3_2.train_v32_language_codec_2m import weak_boundary_starts
...
def main() -> None:
    ...
    parser.add_argument("--archive", type=Path, default=Path(r"archive"))
    ...
    parser.add_argument("--out-dir", type=Path, default=Path(r"archive\v3_checkpoint_audit_20260703\probe_suite"))
