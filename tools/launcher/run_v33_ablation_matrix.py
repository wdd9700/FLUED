...
tools/train/train_v33.py.  It deliberately stays thin: train_v33.py remains the
...
TRAIN_SCRIPT = REPO_ROOT / "tools" / "train" / "train_v33.py"
...
def main() -> None:
    ...
    parser.add_argument("--matrix", default="configs/v33_ablation_2m.json")
