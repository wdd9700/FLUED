...
robocopy "checkpoints\e1_v2_seed999" "K:\FLUED_archive\v2_final_seeds\e1_v2_seed999" /E /R:3 /W:10
Write-Log "seed999 robocopy exit: $LASTEXITCODE"

# Step 2: Copy root log files
Write-Log "Step 2: Copying root log files..."
Copy-Item "checkpoints\a_class_v2_summary.json" "K:\FLUED_archive\v2_final_seeds\" -Force
Copy-Item "checkpoints\ablation_run.log" "K:\FLUED_archive\ablation_20260611\" -Force
Copy-Item "checkpoints\e1_smoke_cpu.log" "K:\FLUED_archive\ablation_20260611\" -Force
Copy-Item "checkpoints\e1_v2_seed42_resume_20260608_041527.log" "K:\FLUED_archive\v2_final_seeds\" -Force
...
$checks = @(
    @{src="checkpoints/ab1_tc020"; dst="K:\FLUED_archive\ablation_20260611\ab1_tc020"; name="AB1 tc=0.20"},
    @{src="checkpoints/ab1_tc030"; dst="K:\FLUED_archive\ablation_20260611\ab1_tc030"; name="AB1 tc=0.30"},
    @{src="checkpoints/ab1_tc045"; dst="K:\FLUED_archive\ablation_20260611\ab1_tc045"; name="AB1 tc=0.45"},
    @{src="checkpoints/ab1_tc060"; dst="K:\FLUED_archive\ablation_20260611\ab1_tc060"; name="AB1 tc=0.60"},
    @{src="checkpoints/ab2_dp03"; dst="K:\FLUED_archive\ab2_denoise_20260612\ab2_dp03"; name="AB2 dp=0.3"},
    @{src="checkpoints/ab2_dp05"; dst="K:\FLUED_archive\ab2_denoise_20260612\ab2_dp05"; name="AB2 dp=0.5"},
    @{src="checkpoints/ab2_dp09"; dst="K:\FLUED_archive\ab2_denoise_20260612\ab2_dp09"; name="AB2 dp=0.9"},
    @{src="checkpoints/e1_v2_seed42"; dst="K:\FLUED_archive\v2_final_seeds\e1_v2_seed42"; name="v2 seed42"},
    @{src="checkpoints/e1_v2_seed123"; dst="K:\FLUED_archive\v2_final_seeds\e1_v2_seed123"; name="v2 seed123"},
    @{src="checkpoints/e1_v2_seed999"; dst="K:\FLUED_archive\v2_final_seeds\e1_v2_seed999"; name="v2 seed999"}
)
