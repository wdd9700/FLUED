param(
    ...
    [string]$NoMemoryCodecCkpt = "archive\v32_masked_codec_2m_20260703\v321_mfl_nomemory_masked_15k",
    [string]$MemoryCodecCkpt = "archive\v32_masked_codec_2m_20260703\v321_mfl_memory_masked_15k",
    [string]$OutRoot = "archive\v32_strict_backbone_20260703_masked_codec_15k",
    [int]$MaxSteps = 3000,
    [int]$BatchSize = 128,
    [int]$NumWorkers = 8,
...
function Run-StrictBackbone {
    ...
    $common = @(
        (Join-Path $repo "tools\analysis\v3_2\train_v32_strict_masked_backbone.py"),
        "--mode", $Mode,
        "--data-path", $DataPath,
        "--out-dir", $runDir,
        "--device", "cuda",
...
python (Join-Path $repo "tools\analysis\v3_2\summarize_v32_min_backbone.py") `
    $OutRoot `
