param(
    ...
    [string]$NoMemoryCodecCkpt = "archive\v32_language_codec_2m_20260703\stage3_v32_mfl_nomemory_10k",
    [string]$MemoryCodecCkpt = "archive\v32_language_codec_2m_20260703\stage3_v32_mfl_memory_10k",
    [string]$OutRoot = "archive\v32_strict_backbone_20260703",
    [int]$MaxSteps = 3000,
    [int]$BatchSize = 128,
    [int]$NumWorkers = 8
)
