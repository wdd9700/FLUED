...
TRAIN = REPO_ROOT / "tools" / "train" / "train_v34_pos_ar_probe.py"


def main() -> None:
    parser = argparse.ArgumentParser()
    parser.add_argument("--matrix", default="configs/v34_pos_ar_40m_probe.json")
    parser.add_argument("--python", default=sys.executable)
    parser.add_argument("--out-root", default=r"K:\FLUED_archive\v34_pos_ar_40m_probe_20260710")
